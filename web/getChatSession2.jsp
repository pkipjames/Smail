...
<html>
    ...
    <body>
        <%
        String uid,chatwithuserno,chatwithuser;
        uid=session.getAttribute("uid")+"";
        chatwithuserno=request.getParameter("rno");
        int e = Integer.parseInt(chatwithuserno);
        Connection con;
        ...
        try{
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/rahul","root","");
             pstm3 =con.prepareStatement("select * from registeration where Registeration_no=? ");
          pstm3.setInt(1,e);
          rs2=pstm3.executeQuery();
          rs2.next();
          chatwithuser=rs2.getString(5);
